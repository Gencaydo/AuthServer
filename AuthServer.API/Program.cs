...
{
    var connectionString = builder.Configuration.GetConnectionString("PgSqlCon");
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://angulartest.gencaydoyurucu.com.tr",
                            "http://localhost:4200") // Specify your localhost URL and port (e.g., React or Angular app)
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
